...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('vchide')
    .setDescription('Hide your temp voice channel from the channel list')
  ...
  async execute(interaction) {
    ...
    await member.voice.channel.permissionOverwrites.edit(everyone, { ViewChannel: false });

    embed
      .setTitle('VC Hidden')
      .setDescription(`**${member.voice.channel.name}** is now hidden from the channel list.`)
      .setColor(0x57F287);
