...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('antiraidvelocity')
    .setDescription('Join velocity analysis')
  ...
  async execute(interaction, args) {
    ...
    const velocityData = await securityEngine.getJoinVelocity(interaction.guild.id, minutes);
    ...
    const embed = new EmbedBuilder()
      .setTitle('Join Velocity Analysis')
      .setDescription(`Join velocity for the last **${minutes}** minutes in **${interaction.guild.name}**`)
      .setColor(isAbnormal ? 0xff0000 : 0x00ff00)
      .addFields(
        { name: 'Total Joins', value: `\`${totalJoins}\``, inline: true },
