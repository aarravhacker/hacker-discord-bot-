...
module.exports = {
  ...
  async execute(interaction, args) {
    ...
    try {
      ...
      await interaction.reply({ embeds: [successEmbed('Color Set', `Welcome embed color set to \`${hex}\`.`)] });
    } catch (err) {
      await interaction.reply({ embeds: [errorEmbed('Error', 'Failed to set welcome color.')] });
    }
  }
};
