...
module.exports = {
  ...
  async execute(interaction) {
    ...
    await member.voice.channel.permissionOverwrites.edit(everyone, { Connect: false });

    embed
      .setTitle('VC Locked')
      .setDescription(`**${member.voice.channel.name}** is now locked. No one else can join.`)
      .setColor(0xED4245);
